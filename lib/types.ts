...
export interface ComplianceRecord { id: string; title: string; customTitle?: boolean; locationId: string; category: RecordCategory; workspace?: RecordWorkspace; recordType?: OperationsRecordType; recordTypeLabel?: string; status: RecordStatus; uploadedBy: string; uploadedById: string; uploadDate: string; lastUpdated: string; description: string; fileNames: string[]; attachments?: { fileId: string; name: string }[]; tags: string[]; relatedRef?: string; classroomAgeGroup?: ClassroomAgeGroup; observationMonth?: string; area?: string; reportingPeriod?: ReportingPeriod }
...
export interface Comment { id: string; recordId: string; user: string; userId: string; role: Role; text: string; timestamp: string; isUnread?: boolean }
