...
export interface ComplianceRecord { id: string; title: string; customTitle?: boolean; locationId: string; locationName?: string; category: RecordCategory; workspace?: RecordWorkspace; recordType?: OperationsRecordType; recordTypeLabel?: string; status: RecordStatus; uploadedBy: string; uploadedById: string; uploadDate: string; createdAt?: string; lastUpdated: string; updatedAt?: string; description: string; fileNames: string[]; attachments?: { fileId: string; name: string; displayName?: string }[]; tags: string[]; relatedRef?: string; classroomAgeGroup?: ClassroomAgeGroup; observationMonth?: string; area?: string; reportingPeriod?: ReportingPeriod }
